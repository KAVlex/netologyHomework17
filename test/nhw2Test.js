...
const Pokemon = require("../nhw2/class/pokemon.js");
const PokemonList = require("../nhw2/class/pokemonList.js");
...
describe('Тестирование класса PokemonList', () => {
    ...
    describe('Тестирование функции add()', () => {
        ...
        it('Добавление Сквиртл-а в пустой список', () => {
    ...
    describe('Тестирование функции show()', () => {
        ...
        it('Вывод пустого списка покемонов', () => {
            ...
            assert.equal(console.log.calledWith('================================='), true);
        });
